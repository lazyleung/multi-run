	...
	if (typeof(window.data) !== 'undefined'){
		...
		for(var p in playerViews){
			...
			if (playerViews[p].name === window.data.data.name){
				playerViews[p].draw(player.xOffset, window.data.data.pos_x/(playerViews[p].canvas_width/window.block_x), window.data.data.pos_y/(playerViews[p].canvas_height/window.block_y), window.data.data.animation_frame);
			} 
		}
